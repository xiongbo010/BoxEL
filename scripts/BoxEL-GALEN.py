...
# for seed in [1111,2222,3333,4444,5555]:
for seed in [6666,7777,8888,9999,1010]:
    ...
    for epoch in range(args.epochs):
        ...
        for step, batch in enumerate(train_generator):
            if step < steps_per_epoch:
                ...
                loss =  nf1_loss + nf1_reg_loss + nf2_loss + nf2_reg_loss + nf3_loss + nf3_reg_loss + nf4_loss + nf4_reg_loss + nf3_neg_loss + nf3_neg_reg_loss
        ...
        PATH = './models/box_el_dim' + str(dimension) + "_lr" + str(learning_rate) + '_batch'+str(batch_size)+'_seed'+ str(seed)+ '.pt'
        if epoch % 20 == 0:
